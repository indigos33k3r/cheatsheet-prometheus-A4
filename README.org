...
| Prometheus footprint                          | alertmanager(15MB RAM), grafana(30MB), node-exporter(10MB), prometheus(350MB). See more [[https://github.com/dennyzhang/cheatsheet-prometheus-A4/blob/master/prometheus-footprint.txt][Link: prometheus-footprint.txt]] |
...
| Client libraries            | Instrument application code. [[https://github.com/dennyzhang/cheatsheet-prometheus-A4/blob/master/prometheus-python-example.py][Link: prometheus-python-example.py]]                     |
